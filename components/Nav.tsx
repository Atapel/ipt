    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-cream-50/70 border-b border-cream-200/60">
      <div className="container-page flex items-center justify-between h-16 md:h-20">
        <Link href="/" className="flex items-center gap-2 group">
          <span className="grid place-items-center h-9 w-9 rounded-full bg-sage-500 text-cream-50 font-display text-lg">
            i
          </span>
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-ink-700">
          ...
          <Link
            href="/contact"
            className="rounded-full bg-ink-900 text-cream-50 px-4 py-2 hover:bg-sage-700 transition-colors"
          >
            Book a session
          </Link>
        </nav>
